...
function updateDisplay()
{
    ...
    if (Winner != null) {
        ...
        if (Winner == 3)
        {
            document.getElementById(`tie-disp`).classList.add("show-disp")
            return
        }
...
{
    // 3 = tie, if theres a winner even though 9 moves was made, itll still change it to the winner! otherwise kept as 3
    if (numOfMoves == 9) {
        Winner = 3
    }
